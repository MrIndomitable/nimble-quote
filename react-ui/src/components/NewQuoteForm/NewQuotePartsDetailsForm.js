...
const QuoteDetails = ({name, total}) => {
  return <div className="form-inline">
    ...
    <InputField id={`${name}.quantity`} placeholder="Quantity" type="number" validate={[required]} />
    <InputField id={`${name}.targetPrice`} placeholder="Target price" type="number" validate={[required]} />
